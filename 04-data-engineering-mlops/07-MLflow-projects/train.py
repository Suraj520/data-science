...
def build_data(data_path):
    ...
    train, test = train_test_split(data, test_size=0.28, random_state=42)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", dest="data_path", help="Data path", default="/home/suraj/ClickUp/Mar-Apr/data/train.csv")
